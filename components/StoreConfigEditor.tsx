          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-3">
              <p className="text-[10px] text-blue-700 font-medium">
                WhatsApp Business API (Meta) — free 1,000 conversations/month. Enter API key and phone number ID from Meta Business Dashboard. Notification templates can use variables: {"{orderId}"}, {"{amount}"}, {"{name}"}, {"{status}"}
              </p>
            </div>
          </div>
        );
